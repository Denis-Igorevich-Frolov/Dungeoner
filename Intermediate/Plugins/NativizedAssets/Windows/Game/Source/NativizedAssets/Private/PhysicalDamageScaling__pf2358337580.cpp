...
FText E__PhysicalDamageScaling__pf__GetUserFriendlyName(int32 InValue)
{
	...
	switch(EnumValue)
	{
		...
		case E__PhysicalDamageScaling__pf::NewEnumerator2: FTextStringHelper::ReadFromBuffer(TEXT("NSLOCTEXT(\"[4AC221754D54741F83B538910DB1DD3B]\", \"22FAD8A14C476E170401D9AC27104995\", \"NewEnumerator2\")"), Text); break;
		case E__PhysicalDamageScaling__pf::E__PhysicalDamageScaling__pf_MAX: FTextStringHelper::ReadFromBuffer(TEXT("Physical Damage Scaling MAX"), Text); break;
